...
<div id="rsccView" style="display: none;">
  <div class="report-container">
    <div style="padding-bottom:5px; margin-bottom: 20px; border-bottom:2px solid #071952">
      <h2 class="fw-bold" style="color:#071952;">Social Triage RSCC Performance Report</h2>
    </div>
    
    <div id="rsccDateDisplay" class="fw-bold text-muted mb-4">January - March 2026</div>
    
    <div class="chart-card mb-4">
      <h5 class="fw-bold text-uppercase text-muted small mb-3">Total Sent to SCC</h5>
    ...
    <div class="chart-card mb-4">
      <h5 class="fw-bold text-uppercase text-muted small mb-3" style="color:#088395 !important;">Total Responded to SCC</h5>
      <div class="chart-container">
